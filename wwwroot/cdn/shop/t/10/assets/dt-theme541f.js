...
Line 139:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 140:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 141:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 157:2 Transforming const to the configured target environment ("es5") is not supported yet
Line 162:6 Transforming const to the configured target environment ("es5") is not supported yet
Line 248:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 250:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 251:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 252:0 Transforming const to the configured target environment ("es5") is not supported yet
Line 253:0 Transforming const to the configured target environment ("es5") is not supported yet
...
$("ul.custom-select").on("click", "li:not(.init)", function() {
  ...
  //$(this).parents('.fbt-product__meta').find(".selectVariant option[value="+selectedVal+"]").trigger('change');//selected=true;
